...
public class Scene_PreStartScreen0 extends Scene
{
	...
	private int timer = 0;
	public Scene_PreStartScreen0(Game game, SceneManager sceneManager) { super(game, sceneManager); }
	...
	public void sceneSetUp()
	{
		...
		preTitleScreen = (o_stuff) Game.createGameObject(new o_stuff(0,0,sys_SpriteLibrary.sprite_screen_PreTitleScreen0));
	...
	public void sceneStep()
	{
		...
		if ( timer > 45 )
		{
			getSceneManager().sceneChangeRequest("Pre Start Screen 1");
		}
	}
	@Override
